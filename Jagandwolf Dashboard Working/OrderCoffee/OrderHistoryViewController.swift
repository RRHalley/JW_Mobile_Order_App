        ...
        databaseRef.observe(DataEventType.value, with: {(DataSnapshot) in
            if DataSnapshot.childrenCount > 0 {
                ...
                for customers in DataSnapshot.children.allObjects as! [DataSnapshot]{
                    ...
                    let customerMotion = customerObject?["OptionMotionShow"]
                    let customerTwist = customerObject?["OptionTwistShow"]
                    let customerAmount = customerObject?["OptionAmountShow"]
                    ...
                    let customer = History(name: (customerName as! String?)!, time: (customerTimes as! String?)!, itemName: (customerItemname as! String?)!, itemType: (customerItemtype as! String?)!, motion: (customerMotion as! String?)!, twist: (customerTwist as! String?)!, amount: (customerAmount as! String?)!, qty: (customerQty as! String?)!, image: (customerImage as! String?)!, date: (customerDate as! String?)!, price: (customerPrice as! String?)!)
