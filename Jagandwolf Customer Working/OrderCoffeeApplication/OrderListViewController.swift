...
class OrderListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            let total = array.compactMap { Double($0.price) }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailLbl?.text = "\(list.value(forKeyPath: "type") ?? String()) \(list.value(forKeyPath: "motion") ?? String()) \(list.value(forKeyPath: "twist") ?? String()) \(list.value(forKeyPath: "amount") ?? String())"
    ...
    @IBAction func confirmOrderBtn(_ sender: Any) {
        ...
        do {
            ...
            for data in result as! [NSManagedObject] {
                ...
                self.rootRef.child("OrderDetail").child(getID).child(today).child("Item\(count)").child("OptionMotion").setValue(data.value(forKey: "motion") as! String)
                self.rootRef.child("OrderDetail").child(getID).child(today).child("Item\(count)").child("OptionTwist").setValue(data.value(forKey: "twist") as! String)
                self.rootRef.child("OrderDetail").child(getID).child(today).child("Item\(count)").child("OptionAmount").setValue(data.value(forKey: "amount") as! String)
                ...
                self.rootRef.child("Order").child(getID).child(getTodayString()).child(getTimeString()).child("OptionMotionShow1").setValue(data.value(forKey: "motion") as! String)
                self.rootRef.child("Order").child(getID).child(getTodayString()).child(getTimeString()).child("OptionTwistShow1").setValue(data.value(forKey: "twist") as! String)
                self.rootRef.child("Order").child(getID).child(getTodayString()).child(getTimeString()).child("OptionAmountShow1").setValue(data.value(forKey: "amount") as! String)
                ...
                self.rootRef.child("CustomerHistoryDetail").child(userID!).child(today).child("Item\(count)").child("OptionMotion").setValue(data.value(forKey: "motion") as! String)
                self.rootRef.child("CustomerHistoryDetail").child(userID!).child(today).child("Item\(count)").child("OptionTwist").setValue(data.value(forKey: "twist") as! String)
                self.rootRef.child("CustomerHistoryDetail").child(userID!).child(today).child("Item\(count)").child("OptionAmount").setValue(data.value(forKey: "amount") as! String)
                ...
                self.rootRef.child("CustomerHistory").child(userID!).child(today).child("OptionMotionShow1").setValue(data.value(forKey: "motion") as! String)
                self.rootRef.child("CustomerHistory").child(userID!).child(today).child("OptionTwistShow1").setValue(data.value(forKey: "twist") as! String)
                self.rootRef.child("CustomerHistory").child(userID!).child(today).child("OptionAmountShow1").setValue(data.value(forKey: "amount") as! String)
            }
